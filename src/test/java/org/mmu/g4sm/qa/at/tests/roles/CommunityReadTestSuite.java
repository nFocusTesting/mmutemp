...
public class CommunityReadTestSuite extends BaseTest{
	...
	public void CommReadSmokeTest_roles_CommunityReadTestSuite(String userName, String password, String userGroup, String rolesFile, String sheetName, String menuItem, String optionOrSetting, String managementGroup, String mgtGroupItem, String runMode, String isSearchPage, String testDataInMandatoryFields, String mandatoryFieldsString) {
		info("TESTING " + menuItem + "->" + optionOrSetting + "->" + managementGroup + "->" + mgtGroupItem);
		
		int searchResultsCount = 0;
		explicitWait(200);			
		info("RUNNING: CommReadSmokeTest_roles_CommunityReadTestSuite");
		...
		try {
			...
			if (userGroup.equals("View Community")) {
...
//			// Read individual records from the table for certain entity types
//			if(mgtGroupItem.equals("Employment Status")) {
//				genericSearchPage.clickLastButtonFromResultsTableByRowNUmber(1);
//				genericSearchPage.waitForJSandJQueryToLoad();
//				info("Assert Check: Verifying if the Edit dialog popup is visible");
//				boolean isEditDialogVisible1 = genericSearchPage.isEditGlossaryDisplayed(mgtGroupItem);
//				Assert.assertTrue(isEditDialogVisible1, "Expecting the Edit Dialog to be visible");
//				info("Assert Check PASSED: Edit Dialog popup is visible");
//				if(userGroup.equals("View Community")) {
//					genericSearchPage.clickDoneButtonInViewDialog(mgtGroupItem);
//				} else {
//					genericSearchPage.clickCancelButtonInEditDialog(mgtGroupItem);
...
//			mainPage.logout();
	...
	private void verifyIfMandatoryFieldsContainDataInPopUpDialog(String mandatoryFieldsString, String managementGroupItem) {
		...
		//String xpathString =  "//div[contains(@class,'ui-dialog')]//div[@class='fieldset']//div[@class='fieldGroup']/div[contains(@class, 'field')]/label[@for='" + mandatoryFieldsString + "']/../descendant::*[2]";
		//String xpathString =  "//div[contains(@class,'ui-dialog')]//div[@class='fieldset']//div[@class='fieldGroup']/div[contains(@class, 'field')]/label[@for='" + mandatoryFieldsString + "']/../descendant::*[@data-binding]";
