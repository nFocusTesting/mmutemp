...
public class CommunityUpdateTestSuite extends BaseTest {
	...
	public void CommUpdateSmokeTest_roles_CommunityUpdateTestSuite(String userName, String password, String userGroup, String rolesFile, String sheetName, String menuItem, String optionOrSetting, String managementGroup, String mgtGroupItem, String runMode, String isSearchPage, String updatingFieldsString) {
		
		info("TESTING " + menuItem + "->" + optionOrSetting + "->" + managementGroup + "->" + mgtGroupItem);
		int searchResultsCount = 0;
		explicitWait(200);			
		info("RUNNING: CommUpdateSmokeTest_roles_CommunityUpdateTestSuite");
		...
		try {
			...
			if(runMode.equalsIgnoreCase("Y")) {
				...
				String firstColumnFirstRowValue = "";
				...
				if(isSearchPage.equals("Y")) {
					...
					firstColumnFirstRowValue=genericSearchPage.getCellDataFromSearchResultsTableByRowNUmberAndColumnIndex(1,1);
