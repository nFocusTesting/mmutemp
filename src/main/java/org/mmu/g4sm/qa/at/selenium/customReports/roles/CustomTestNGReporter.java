...
import org.mmu.g4sm.qa.at.selenium.utils.ConfigurationFactory;
...
public class CustomTestNGReporter extends ConfigurationFactory implements IReporter  {
	
	private static String reportTemplatePath="/src/resources/reportTemplates/";
	private static final String emailableReportTemplateFile = System.getProperty( "user.dir" ) + reportTemplatePath + "customize-emailable-report-template.html";
	//System.getProperty( "user.dir" ) + reportTemplatesPath + "customize-emailable-report-template.html"
