package org.mmu.g4sm.qa.at.selenium.customReports.roles;
...
public class CustomTestNgReporter1 implements IReporter {
	
    private static final Logger LOG = Logger.getLogger(CustomTestNgReporter1.class);
    ...
    private static final String JVM_ARG = "custom-emailable.report2.name";
    ...
    protected void writeStylesheet() {
        ...
        writer.print(".failedodd td,.attn {background-color: #F33; color: white}");
        writer.print(".failedeven td,.stripe .attn {background-color: #D00; color: white}");
...
//                        .append("</a>").toString());
              writeTableData(buffer.append("<a href=\"#t").append(testIndex)
              .append("\">")
              .append(Utils.escapeHtml("CurricReadSmokeTest"))
              .append("</a>").toString()); 
                ...
                writeTableData(getDurationInHHmmssSSS(duration), "num");
        ...
        if (testIndex > 1) {
            ...
            writeTableHeader(getDurationInHHmmssSSS(totalDuration), "num");
    ...
    protected void writeScenarioSummary() {
        ...
        writer.print("<th>U4SM Entity</th>");
        writer.print("<th>User</th>");
        writer.print("<th>Start Date&Time</th>");
        writer.print("<th>Time (hh:mm:ss)</th>");
        writer.print("</tr>");
        writer.print("</thead>");
...
//                      String userAndMgtItem = Utils.escapeHtml(getUserAndManagementItemParameters(scenarioIndex, result));
//                      String methodName = userAndMgtItem;
//                      
//                      long start = result.getStartMillis();
//                      long end = result.getEndMillis();
//                      long duration = end - start;
//                      String startInDateTimeFormat = getEpochInDateTimeFormat(start);
//                      String endInDateTimeFormat = getEpochInDateTimeFormat(end);
//                	
//                      scenarioIndex++;
//                  }
                    ...
                    // THE BELOW CODE SHOULD BE UNCOMMENTED IF IT DOES NOT WORK 
                    String userAndMgtItem = Utils.escapeHtml(getManagementItemParameters(scenarioIndex, firstResult));
                    String methodName = userAndMgtItem;
                    String userName = Utils.escapeHtml(getUserParameters(scenarioIndex, firstResult));
                    ...
                    // I COMMENTED OUT BELOW LINES CODE WHICH SEEMS TO BE CORRECT
...
//                            .append(resultsCount).append("\">").append(startInDateTimeFormat)
//                            .append("</td>").append("<td rowspan=\"")
//                            .append(resultsCount).append("\">")
//                            .append(getDurationInHHmmssSSS(duration)).append("</td></tr>");

                  //MY MODIFIED CODE1
//                  buffer.append("<td><a href=\"#m").append(scenarioIndex)
//                  .append("\">").append(methodName)
//                  .append("</a></td>").append("<td>").append(userName).append("</td>").append("<td rowspan=\"")
//                  .append(resultsCount).append("\">").append(startInDateTimeFormat)
//                  .append("</td>").append("<td rowspan=\"")
//                  .append(resultsCount).append("\">")
//                  .append(getDurationInHHmmssSSS(duration)).append("</td></tr>");
                  
                  //END OF MY MODIFIED CODE1
                  
                  
                  String linkTextStyle="";  
                  if(cssClassPrefix.equals("failed")) {
                	  linkTextStyle = "\"color:white\"";
                  } 
                  
                  buffer.append("<td><a href=\"#m").append(scenarioIndex)
                  .append("\">").append(methodName)
                  .append("</a></td>").append("<td>").append(userName).append("</td>").append("<td>")
                  .append(startInDateTimeFormat)
                  .append("</td>").append("<td>")
                  .append(getDurationInHHmmssSSS(duration)).append("</td></tr>");                  
                  
                  scenarioIndex++;

                    // Write the remaining scenarios for the method. BELO IS COMMENTED WHICH SEEMS TO BE CORRECT 
//                    for (int i = 1; i < resultsCount; i++) {
//                    	String methodName1 = Utils.escapeHtml(getManagementItemParameters(scenarioIndex, results.get(i)));
//                        buffer.append("<tr class=\"").append(cssClass)
//                                .append("\">").append("<td><a href=\"#m")
//                                .append(scenarioIndex).append("\">")
//                                .append(methodName1).append("</a></td></tr>");
//                        scenarioIndex++;
//                    }
                         
                    for (int i = 1; i < resultsCount; i++) {
                    	String methodName1 = Utils.escapeHtml(getManagementItemParameters(scenarioIndex, results.get(i)));
                    	String userName1 = Utils.escapeHtml(getUserParameters(scenarioIndex, results.get(i)));
                        long startTime = results.get(i).getStartMillis();
                        long endTime = results.get(i).getEndMillis();
                        long durationOfTest = endTime - startTime;
                        String startInDateTimeFormatForTest = getEpochInDateTimeFormat(startTime);
                        String endInDateTimeFormatForTest = getEpochInDateTimeFormat(endTime);
                    	
                        buffer.append("<tr class=\"").append(cssClass)
                                .append("\">").append("<td><a href=\"#m")
                                .append(scenarioIndex).append("\">")
                                .append(methodName1).append("</a></td>").append("<td>")
                                .append(userName1).append("</td>").append("<td>")
                                .append(startInDateTimeFormatForTest).append("</td>")
                                .append("<td>").append(getDurationInHHmmssSSS(durationOfTest)).append("</td>").append("</tr>");
                        scenarioIndex++;
                    }
...
//                    ITestResult firstResult = results.iterator().next();
//                    //String methodName = Utils.escapeHtml(firstResult.getMethod().getMethodName());
//                    String userAndMgtItem = Utils.escapeHtml(getUserAndManagementItemParameters(scenarioIndex, firstResult));
//                    String methodName = userAndMgtItem;
//                    
//                    //Updating from here 
//                    
////                    for (ITestResult result : results) {
////                    	String temp = getUserAndManagementItemParameters(scenarioIndex, result );
////                        scenarioIndex++;
////                    }
//                    //End of updating from here 
//                    
//                    long start = firstResult.getStartMillis();
//                    long end = firstResult.getEndMillis();
//                    long duration = end - start;
...
////                    .append(resultsCount).append("\">").append(startInDateTimeFormat)
////                    .append("</td>").append("<td rowspan=\"")
////                    .append(resultsCount).append("\">").append(endInDateTimeFormat)
////                    .append("</td>").append("<td rowspan=\"")
////                    .append(resultsCount).append("\">")
////                    .append(getDurationInHHmmssSSS(duration)).append("</td></tr>");       
//                    scenarioIndex++;
...
//    }
    ...
    /**
     * Get ManagementGroupItem and User 
     */
    
    private String getManagementItemParameters(int scenarioIndex, ITestResult result ) {
        boolean hasRows = false;
        String userAndManagementItem = null;
        String userName = null;
        String userGroup = null;
        String managementGroupItem = null;
        ...
        if (parameterCount > 0) {
        	...
        	managementGroupItem = parameters[5].toString() + "->" + parameters[6].toString() + "->" + parameters[7].toString() + "->" + parameters[8].toString();
        }	
        //userAndManagementItem = userName + " " +  managementGroupItem;
        return managementGroupItem;
        //return userAndManagementItem; 	
    }
    
    private String getUserParameters(int scenarioIndex, ITestResult result ) {
        boolean hasRows = false;
        String userAndManagementItem = null;
        String userName = null;
        String userGroup = null;
    ...
    protected void writeReporterMessages(List<String> reporterMessages) {
        ...
        if (CustomTestNgReporter1.getEscapeHtml()) {
    ...
    protected void writeStackTrace(Throwable throwable) {
        ...
        writer.print(CustomTestNgReporter1.shortStackTrace(throwable, true));
        writer.print("</div>");
    }
    ...
    public String getDurationInHHmmssSSS(long durationInMilliSeconds) {
    	//return DurationFormatUtils.formatDuration(durationInMilliSeconds, "HH:mm:ss,SSS");
    	return DurationFormatUtils.formatDuration(durationInMilliSeconds, "HH:mm:ss");
    }
    
    public String getEpochInDateTimeFormat(long durationInMilliSeconds) {
    	   ZonedDateTime dateTime = Instant.ofEpochMilli(durationInMilliSeconds).atZone(ZoneId.of("GMT"));
